...
export const metadata: Metadata = {
  title: "Resume — Kashif Jilani",
  description:
    "Plain-text resume of Kashif Jilani — Senior .NET Engineer / Tech Lead. .NET Core, C#, ASP.NET, SQL Server, Microsoft Azure, Angular, legacy modernization, digital banking.",
